...
## Daily Stand-ups (max 10 marks)
  ...
  Daily Stand-ups Total Mark: __10 / 10
...
## User Stories (Tracked in Jira) (max 10 marks) 
  ...
  - Clearly Defined Acceptance Criteria (max 2 marks)
    ...
    Your Mark: _ 0 no acceptance criteria for most of tickets
...
## Tracking on Jira  (max 24 marks) 
  ...
  - Is the git commit message clear? (max 2 marks)
    ...
    Your Mark: _1 commit msg like 'clean up' is not clear. sha: b691011d4ec2ee91a7b2e9c71ef0b308b4267bec
...
Tracking on Jira Total Mark: _22_ / 24
...
## Documentation (max 1 mark)
  ...
  Your Mark: _0_ / 1 didn't see documentation file
