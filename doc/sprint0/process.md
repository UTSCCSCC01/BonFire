...
Also, team members have different views about certain features which can complement each other so in the future when we are implementing the project, we will often reviews one's another work to enhance its quality.
